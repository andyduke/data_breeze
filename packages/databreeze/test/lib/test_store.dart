...
class TestStore extends BreezeStore {
  ...
  Future<List<BreezeDataRecord>> fetchAllRecords({
    ...
    log?.fine('Fetch All $options: $result');
  ...
  Future<void> updateRecord({
    ...
    log?.fine('Update #$keyValue: $record');
  }
  ...
  Future<void> deleteRecord({
    ...
    log?.fine('Delete #$keyValue: $record');
  }
